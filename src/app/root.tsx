...
export function meta() {
  return [
    ...
    { name: "keywords", content: "IT solutions, software development, IT infrastructure, manpower services, security services, facility management, AMC services, ITES" },
    { name: "author", content: "Emdee Techno Services" },
    { property: "og:type", content: "website" },
    { property: "og:locale", content: "en_US" },
    { property: "og:url", content: "https://emdee.in" },
    { property: "og:site_name", content: "Emdee Techno Services" },
    { property: "og:title", content: "Emdee Techno Services - IT Solutions & Services" },
    { property: "og:description", content: "Leading provider of IT infrastructure, software development, manpower solutions, security services, and comprehensive facility management." },
    { name: "twitter:card", content: "summary_large_image" },
    { name: "twitter:title", content: "Emdee Techno Services - IT Solutions & Services" },
    { name: "twitter:description", content: "Leading provider of IT infrastructure, software development, manpower solutions, security services, and comprehensive facility management." },
