...
import { tilesData } from "@/components/ITESPage/tilesData";
...
export function meta() {
  return [
    { title: "IT Enabled Services (ITES) | Emdee Techno Services" },
    { name: "description", content: "IT Enabled Services including business process outsourcing, customer support, data management, and back-office operations." },
    { property: "og:title", content: "IT Enabled Services (ITES) | Emdee Techno Services" },
    { property: "og:description", content: "IT Enabled Services including business process outsourcing, customer support, data management, and back-office operations." },
    { property: "og:url", content: "https://emdee.in/ites" }
  ];
}

export default function ITESPage() {
  ...
  // Image refs to check if already loaded
  ...
  useEffect(() => {
    if (desktopImageRef.current?.complete || mobileImageRef.current?.complete) {
    ...
    <div className="min-h-screen bg-[#0A0A0A] font-qanelas-soft">
      ...
      <div className="hidden md:block pt-20">
        <div className="relative">
          ...
          >
            <img
              src="https://ucarecdn.com/e51581cd-1b6f-415d-b7d8-dc225b737355/-/format/auto/"
        ...
        >
          ...
          >
            We deliver technology-enabled services that support large-scale
            government operations, public service delivery and institutional
            workflows. Backed by two decades of execution across 10+ states,
            500+ government projects and tens of millions of citizen-level
            transactions, our ITeS capabilities combine field operations,
            process management and technology to run mission-critical public
            programmes at scale.
          </motion.p>
        </div>
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-8 pb-32">
          <ITESNavigationIndicator
            ...
            customIndexTitles={{
              1: "OCR-based Utility Billing",
              5: "E-governance Delivery",
              7: "Training, Education & Capacity",
            }}
          />
      ...
      <div className="md:hidden pt-20">
        ...
        >
          <img
            src="https://ucarecdn.com/0a092c5d-82c6-40f2-ad7e-8833f9f60c09/-/format/auto/"
            alt="IT Enabled Services"
            className="w-full h-auto object-contain"
            ref={mobileImageRef}
            onLoad={() => setHeroImageLoaded(true)}
