        ...
        <div className="mt-20 pt-16 border-t border-white/5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-[1200px] mx-auto">
            ...
            <Link
              ...
              className="group flex gap-5 p-6 rounded-2xl border border-white/5 bg-white/[0.01] backdrop-blur-md hover:bg-white/[0.03] hover:border-green-500/20 transition-all duration-300 shadow-xl hover:-translate-y-1.5"
            >
            ...
            <Link
              ...
              className="group flex gap-5 p-6 rounded-2xl border border-white/5 bg-white/[0.01] backdrop-blur-md hover:bg-white/[0.03] hover:border-purple-500/20 transition-all duration-300 shadow-xl hover:-translate-y-1.5"
            >
            ...
            <Link
              ...
              className="group flex gap-5 p-6 rounded-2xl border border-white/5 bg-white/[0.01] backdrop-blur-md hover:bg-white/[0.03] hover:border-cyan-500/20 transition-all duration-300 shadow-xl hover:-translate-y-1.5"
            >
            ...
            <Link
              ...
              className="group flex gap-5 p-6 rounded-2xl border border-white/5 bg-white/[0.01] backdrop-blur-md hover:bg-white/[0.03] hover:border-[#FF6B35]/20 transition-all duration-300 shadow-xl hover:-translate-y-1.5"
            >
